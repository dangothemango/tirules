...
<h2>Acquiescence <sub>(Promissory Note)</sub></h2>
    <ol class="note">
...
<h2>Acquiescence &Omega; <sub>(Promissory Note)</sub></h2>
    <ol class="note">
...
<h2>Salai Sai Corian <sub>(Flagship)</sub></h2>
    <ol class="note">
...
<h2>Berekar Berekon <sub>(Agent)</sub></h2>
    <ol class="note">
    <li><sc>Production</sc> limits still apply.</li>
    </ol>

<h2>Rickar Rickani <sub>(Commander)</sub></h2>
    <ol class="note">
...
<h2>Mathis Mathinus &mdash; Imperial Seal <sub>(Hero)</sub></h2>
    <ol class="note">
...
<h2>Imperator <sub>(Breakthrough)</sub></h2>
    <ol class="note">
