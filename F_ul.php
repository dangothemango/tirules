...
<h2>Hel&ndash;Titan <sub>(Unit)</sub></h2>
    ...
    <li>Effects that move ground forces, such as the <i>Ghost Squad</i> action card or the ability of the N&rsquo;orr player&rsquo;s commander, G&rsquo;hom Sek&rsquo;kus, (via the <i>Alliance</i> promissory note), cannot be used to move a Hel&ndash;Titan to another planet.</li>
...
<h2>Tungstantus <sub>(Commander)</sub></h2>
    ...
    <ol>
        <li>The trade good may be spent as it is gained. The number of trade goods the Ul player has after producing units is used to determine if the Mentak player may use their <sc>Pillage</sc> ability.</li>
        <li>A trade good will not be gained unless at least one unit is produced.</li>
    </ol>
