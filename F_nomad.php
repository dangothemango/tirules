...
<h2>The Cavalry <sub>(Promissory Note)</sub></h2>
    ...
    <ol>
        ...
        <li>In a future combat, the damaged ship may be repaired by the <i>Duranium Armor</i> technology. It will be unable to be damaged again unless it has regained the <sc>Sustain Damage</sc> ability.</li>
...
<h2>Field Marshal Mercer <sub>(Agent)</sub></h2>
    ...
    <li>The ground forces may be placed on one or two planets.</li>
