...
<header><h1>The Naalu Collective</h1></header>
<article>
<h2>Telepathic</h2>
    <ol class="note">
...
<h2>Gift of Prescience <sub>(Promissory Note)</sub></h2>
    <ol class="note">
...
<h2>Neuroglaive <sub>(Technology)</sub></h2>
    <ol class="note">
...
<h2>Hybrid Crystal Fighter <sub>(Unit)</sub></h2>
    <ol class="note">
    </ol>

<h2>Matriarch <sub>(Flagship)</sub></h2>
    <ol class="note">
...
<h2>Z&rsquo;eu <sub>(Agent)</sub></h2>
    <ol class="note">
...
<h2>Z&rsquo;eu &Omega; <sub>(Agent)</sub></h2>
    <ol class="note">
...
<h2>Z&rsquo;eu &Omega;&Omega; <sub>(Agent)</sub></h2>
    <ol class="note">
...
<h2>M&rsquo;aban <sub>(Commander)</sub></h2>
    <ol class="note">
...
<h2>M&rsquo;aban &Omega; <sub>(Commander)</sub></h2>
    <ol class="note">
...
<h2>Mindsieve <sub>(Breakthrough)</sub></h2>
    <ol class="note">
