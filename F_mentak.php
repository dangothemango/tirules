...
<header><h1>The Mentak Coalition</h1></header>
<article>
<h2>Ambush</h2>
    <ol class="note">
...
<h2>Promise of Protection <sub>(Promissory Note)</sub></h2>
    <ol class="note">
...
<h2>Mirror Computing <sub>(Technology)</sub></h2>
    <ol class="note">
...
<h2>Salvage Operations <sub>(Technology)</sub></h2>
    <ol class="note">
...
<h2>Fourth Moon <sub>(Flagship)</sub></h2>
    <ol class="note">
    </ol>

<h2>Suffi An <sub>(Agent)</sub></h2>
    <ol class="note">
    </ol>

<h2>S&rsquo;ula Mentarion <sub>(Commander)</sub></h2>
    <ol class="note">
    <li>The Mentak player&rsquo;s opponent chooses which promissory note they give to the Mentak player.</li>
    <li>Giving a promissory note because of S&rsquo;ula Mentarion is not resolving a transaction.</li>
...
<h2>Ipswitch, Loose Cannon &mdash; Sleeper Cell <sub>(Hero)</sub></h2>
    <ol class="note">
...
<h2>Moll Terminus <sub>(Mech)</sub></h2>
    <ol class="note">
...
<h2>The Table&rsquo;s Grace <sub>(Breakthrough)</sub></h2>
    <ol class="note">
    </ol>

<h2>Corsair <sub>(Unit)</sub></h2>
    <ol class="note">
